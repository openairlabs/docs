---
title: "AI Agent Chat"
description: "Ask in plain English to get charts, tables, and reports instantly."
keywords:
...
Ask in plain English and get charts, tables, and reports instantly to guide your next move.

## Why it matters
- Faster answers — Skip manual digging and get direct results.
- Less debate — Share-ready charts and tables keep everyone aligned.
- More momentum — Recommendations help move from “what happened?” to “what next?”.

## How to use
<Steps>
  <Step title="Open AI Agent">
    Use the chat on your dashboard to start a session.
  </Step>
  <Step title="Ask a question">
    Use plain English. Example: “Show ROAS by platform for last 30 days.”
  </Step>
  <Step title="Refine with follow‑ups">
    Ask for breakdowns, comparisons, or time ranges.
  </Step>
  <Step title={<a href="/features/reports-analytics">Share via Reports</a>}>
    Save or reference visualizations alongside unified KPIs.
  </Step>
</Steps>
...
### AI Agent vs. Manual Analysis (When to use which)

| Scenario | Use AI Agent Chat | Use manual analysis |
| --- | --- | --- |
| Quick answers and visuals | ✅ Plain-English prompts to charts/tables | — |
| Exploratory questions | ✅ Fast iterations with follow-ups | — |
| Deep custom analysis | — | ✅ Complex, bespoke analysis |
| Repeatable reporting | ✅ Generates summaries and visuals | — |
| Audit/validation | — | ✅ Verify against native platforms |

## FAQ: direct answers
### What does the AI Agent generate?
Charts, tables, and reports from plain‑English prompts.

### Which platforms does it analyze?
Google Ads and Meta Ads today; CRM, lead distribution, and accounting integrations are coming soon.

### How fast can I get started?
Most teams connect and see data in minutes. Start with the <a href="/getting-started/quickstart-guide">Quick Start Guide</a>.
